...
1. **[`src/Artemis_Flight_Computer.cpp`](src/Artemis_Flight_Computer.cpp):** Código fuente principal optimizado, no bloqueante y documentado para la evaluación de los jueces.
